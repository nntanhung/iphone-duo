...
>
> - Modify **custom screen image uploads**, including separate images for the outer and inner screens.
> - Added a button to hide (and show) the Control UI.
...
> - Added **Full HD (1920 × 1080) recording at 60 fps**, with an 8.6-second WebM animation export. Animation for video export also follow Outer → Inner → Outer cycle.
>
> See the sections below for the current controls, source layout, and deployment details.

[Live demo (forked version)](https://iphone-duo-mu.vercel.app/)
